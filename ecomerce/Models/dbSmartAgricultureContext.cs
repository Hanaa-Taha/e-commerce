...
namespace ecomerce.Models
{
    public partial class dbSmartAgricultureContext : ecomerceContext
    {
        ...
        protected dbSmartAgricultureContext(DbContextOptions options)
            : base(options)
        {
        }
        /*
...
//#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Server=DESKTOP-EQKKVG6\\SQLSERVERTWO;Database=dbSmartAgriculture;Trusted_Connection=True;");
            }
        }
